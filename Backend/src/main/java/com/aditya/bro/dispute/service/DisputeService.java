...
public class DisputeService {
    ...
    public Dispute flagDispute(String surveyNumber, String reason, String raisedBy, List<String> evidenceIpfsHashes) {
        Dispute dispute = new Dispute();
        dispute.setSurveyNumber(surveyNumber);
        dispute.setRaisedBy(raisedBy);
        dispute.setReason(reason);
        dispute.setEvidenceIpfsHashes(evidenceIpfsHashes);
